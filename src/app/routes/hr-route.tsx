...
import { TaskList } from '~/app/pages/tasks/task-list'
import { TaskDetail } from '~/app/pages/tasks/task-detail'
...
export const hrRoute = [
    ...
    // TASKS
    { path: APP_ROUTES.TASKS, element: <TaskList /> },
    { path: APP_ROUTES.TASK_DETAIL, element: <TaskDetail /> },
]
