...
import { CreateEmployeeRequestType as UpdateEmployeeRequestType } from '~/app/types/employee/request/employee.type'
...
export default function EmployeeUpdate() {
    ...
    const {
        ...
        // Cast resolver to any because schema inference may not exactly match the form type
